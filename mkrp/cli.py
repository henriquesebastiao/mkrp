...
import typer
from modules import get_gitignore
from modules.license import MIT
from modules.settings import SETTINGS_PYTHON
from modules.workflows import CI_PYTHON
...
def python(
    ...
    try:
        ...
        console.print(f'[bold red]Error:[/bold red] {e} is not a valid tech.')
